...
t.exports=function(e,t,n){return n=n||{},o.debug("Strategy: cache first ["+e.url+"]",n),o.openCache(n).then(function(t){return t.match(e).then(function(t){var i=n.cache||r.cache,c=Date.now()
return o.isResponseFresh(t,i.maxAgeSeconds,c)?t:o.fetchAndCache(e,n)})})}},{"../helpers":1,"../options":4}],8:[function(e,t,n){"use strict"
var r=e("../options"),o=e("../helpers")
t.exports=function(e,t,n){return n=n||{},o.debug("Strategy: cache only ["+e.url+"]",n),o.openCache(n).then(function(t){return t.match(e).then(function(e){var t=n.cache||r.cache,i=Date.now()
if(o.isResponseFresh(e,t.maxAgeSeconds,i))return e})})}},{"../helpers":1,"../options":4}],9:[function(e,t,n){"use strict"
...
return o.debug("Strategy: network first ["+e.url+"]",n),o.openCache(n).then(function(t){var s,a,u=[]
if(c){var f=new Promise(function(i){s=setTimeout(function(){t.match(e).then(function(e){var t=n.cache||r.cache,c=Date.now(),s=t.maxAgeSeconds
o.isResponseFresh(e,s,c)&&i(e)})},1e3*c)})
u.push(f)}var h=o.fetchAndCache(e,n).then(function(e){if(s&&clearTimeout(s),i.test(e.status))return e
throw o.debug("Response was an HTTP error: "+e.statusText,n),a=e,new Error("Bad response")}).catch(function(r){return o.debug("Network or response error, fallback to cache ["+e.url+"]",n),t.match(e).then(function(e){if(e)return e
if(a)return a
throw r})})
return u.push(h),Promise.race(u)})}},{"../helpers":1,"../options":4}],12:[function(e,t,n){"use strict"
var r=e("../helpers")
...
c+=f.prefix+h}}else c+=f}return c}}function s(e){return e.replace(/([.+*?=^!:${}()[\]|\/\\])/g,"\\$1")}function a(e){return e.replace(/([=!:$\/()])/g,"\\$1")}function u(e,t){return e.keys=t,e}function f(e){return e.sensitive?"":"i"}function h(e,t,n){l(t)||(n=t||n,t=[])
for(var r=(n=n||{}).strict,o=!1!==n.end,i="",c=0;c<e.length;c++){var a=e[c]
if("string"==typeof a)i+=s(a)
else{var h=s(a.prefix),p="(?:"+a.pattern+")"
t.push(a),a.repeat&&(p+="(?:"+h+p+")*"),i+=p=a.optional?a.partial?h+"("+p+")?":"(?:"+h+"("+p+"))?":h+"("+p+")"}}var d=s(n.delimiter||"/"),m=i.slice(-d.length)===d
return r||(i=(m?i.slice(0,-d.length):i)+"(?:"+d+"(?=$))?"),i+=o?"$":r&&m?"":"(?="+d+"|$)",u(new RegExp("^"+i,f(n)),t)}function p(e,t,n){return l(t)||(n=t||n,t=[]),n=n||{},e instanceof RegExp?function(e,t){var n=e.source.match(/\((?!\?)/g)
if(n)for(var r=0;r<n.length;r++)t.push({name:r,prefix:null,delimiter:null,optional:!1,repeat:!1,partial:!1,asterisk:!1,pattern:null})
return u(e,t)}(e,t):l(e)?function(e,t,n){for(var r=[],o=0;o<e.length;o++)r.push(p(e[o],t,n).source)
return u(new RegExp("(?:"+r.join("|")+")",f(n)),t)}(e,t,n):function(e,t,n){return h(r(e,n),t,n)}(e,t,n)}var l=e("isarray")
